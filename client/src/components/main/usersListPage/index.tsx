...
const UsersListPage = (props: UserListPageProps) => {
  const { filteredUserlist, setUserFilter } = useUsersListPage();
  ...
  return (
    <div className='user-card-container'>
      <UsersListHeader userCount={filteredUserlist.length} setUserFilter={setUserFilter} />
      ...
      {(!filteredUserlist.length || filteredUserlist.length === 0) && (
